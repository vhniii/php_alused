...
<div class="main-menu">
    ...
    <ul>
        ...
        <li><a href="tooted.php?leht=tooted">Tooted</a></li>
        <li><a href="hinnakiri.php?leht=hinnakiri">Hinnakiri</a></li>
...
if(!empty($_GET('leht'))) {
    ...
    if ($check == true) {
        ...
        echo 'Sellist lehte ei eksisteeri!';
